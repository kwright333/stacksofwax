...
(5, 'Dark Side of the Moon', 'Pink Floyd', 1973, 'Progressive Rock', 'Harvest', '[\"Harvest\",\"Capitol\",\"Speak to Me\",\"Breathe\",\"On the Run\",\"Time\",\"The Great Gig in the Sky\",\"Money\",\"Us and Them\",\"Any Colour You Like\",\"Brain Damage\",\"Eclipse\"]', 0, 'https://upload.wikimedia.org/wikipedia/en/3/3b/Dark_Side_of_the_Moon.png'),
(6, 'Rumours', 'Fleetwood Mac', 1977, 'Pop Rock', 'Warner Bros.', '[\"Warner Bros.\",\"Second Hand News\",\"Dreams\",\"Never Going Back Again\",\"Don\'t Stop\",\"Go Your Own Way\",\"Songbird\",\"The Chain\",\"You Make Loving Fun\",\"I Don\'t Want to Know\",\"Oh Daddy\",\"Gold Dust Woman\"]', 0, 'https://upload.wikimedia.org/wikipedia/en/f/fb/FMacRumours.PNG'),
...
(16, 'Thriller', 'Michael Jackson', 1982, 'Pop', 'Epic', '[\"Epic\",\"Wanna Be Startin\' Somethin\'\",\"Baby Be Mine\",\"The Girl Is Mine (with Paul McCartney)\",\"Thriller\",\"Beat It\",\"Billie Jean\",\"Human Nature\",\"P.Y.T. (Pretty Young Thing)\",\"The Lady in My Life\"]', 0, 'https://upload.wikimedia.org/wikipedia/en/5/55/Michael_Jackson_-_Thriller.png'),
...
(19, 'Appetite for Destruction', 'Guns N\' Roses', 1987, 'Hard Rock', 'Geffen', '[\"Geffen\",\"Welcome to the Jungle\",\"It\'s So Easy\",\"Nightrain\",\"Out ta Get Me\",\"Mr. Brownstone\",\"Paradise City\",\"My Michelle\",\"Think About You\",\"Sweet Child o\' Mine\",\"You\'re Crazy\",\"Anything Goes\",\"Rocket Queen\"]', 0, 'https://upload.wikimedia.org/wikipedia/en/6/60/GunsnRosesAppetiteforDestructionalbumcover.jpg'),
...
(22, 'Like a Prayer', 'Madonna', 1989, 'Pop', 'Sire', '[\"Sire\",\"Cherish\",\"Express Yourself\",\"Love Song\",\"Oh Father\",\"Promise to Try\",\"Keep It Together\",\"Spanish Eyes\",\"Act of Contrition\",\"Like a Prayer\"]', 0, 'https://upload.wikimedia.org/wikipedia/en/thumb/0/08/Madonna_-_Like_a_Prayer_album.png/220px-Madonna_-_Like_a_Prayer_album.png'),
...
(55, '21', 'Adele', 2011, 'Pop', 'XL', '[\"XL\",\"Rolling in the Deep\",\"Rumour Has It\",\"Turning Tables\",\"Don\'t You Remember\",\"Set Fire to the Rain\",\"He Won\'t Go\",\"Take It All\",\"I\'ll Be Waiting\",\"One and Only\",\"Lovesong\",\"Someone Like You\"]', 0, 'https://upload.wikimedia.org/wikipedia/en/1/1b/Adele_-_21.png'),
...
(58, 'Blonde', 'Frank Ocean', 2016, 'R&B', 'Boys Don\'t Cry', '[\"Boys Don\'t Cry\",\"Nikes\",\"Ivy\",\"Pink + White\",\"Be Yourself\",\"Solo\",\"Skyline To\",\"Self Control\",\"Good Guy\",\"Nights\",\"Solo (Reprise)\",\"Pretty Sweet\",\"Facebook Story\",\"Close to You\",\"White Ferrari\",\"Siegfried\",\"Godspeed\",\"Futura Free\"]', 0, 'https://upload.wikimedia.org/wikipedia/en/a/a0/Blonde_-_Frank_Ocean.jpeg'),
